...
export const LiveCreatorIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const FriendsActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LiveStudioSidebarIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LiveStudioActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LoveIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const FavouriteSolidIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
...
export const PlayRegularIcon = ({ width = '1.8rem', height = '1.8rem', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const EditIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width={width}
...
export const PrivatedIcon = ({ width = '1.8rem', height = '1.8rem', className }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width={width}
...
export const LinkedInIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width={width}
...
export const PinterestIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width={width}
...
export const ScrollToRightIcon = ({ width = '1.8rem', height = '1.8rem', className }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width={width}
...
export const LoveIconRegular = ({ width = '1.8rem', height = '1.8rem', className }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width={width}
